...
# This analysis is aimed to analyze the results that are obtained in 'bdb_analysis_V9'.

```{r}
load("H:/ravi_dsi_summer_project/bdb_analysis_V9/all_results_162_1-25.RData")
```
...
```{r}
write.csv(results_df, "H:/ravi_dsi_summer_project/bdb_analysis_V12/results_df_162_1-25.csv")
```
