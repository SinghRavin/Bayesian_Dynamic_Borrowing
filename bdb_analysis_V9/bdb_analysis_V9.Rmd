...
# This analysis will only cover the sample size of 162. And we will consider only the replicates 1 to 25.
...
save(all_results, file = "H:/ravi_dsi_summer_project/bdb_analysis_V9/all_results_162_1-25.RData")
```
