...
# This analysis is aimed to create the results data set that are obtained in 'bdb_analysis_V15'.

```{r}
load("H:/ravi_dsi_summer_project/bdb_analysis_V15/all_results_162_26-35.RData")
```
...
```{r}
results_df <- expand.grid(1:num_vars, 1:num_prior_sets, (early_reps+1):(early_reps+num_reps), 1:num_het_conds)
...
```{r}
write.csv(results_df, "H:/ravi_dsi_summer_project/bdb_analysis_V18/results_df_162_26-35.csv")
```
