...
# This analysis is aimed to create the results data set that are obtained in 'bdb_analysis_V16'.

```{r}
load("H:/ravi_dsi_summer_project/bdb_analysis_V16/all_results_100_26-35.RData")
```
...
```{r}
write.csv(results_df, "H:/ravi_dsi_summer_project/bdb_analysis_V17/results_df_100_26-35.csv")
```
