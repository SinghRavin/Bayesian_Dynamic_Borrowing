...
# This analysis will only cover the sample size of 100. And we will consider only the replicates 1 to 35.
...
save(all_results, file = "H:/ravi_dsi_summer_project/bdb_analysis_V10/all_results_100_1-25.RData")
```
