...
# This analysis is aimed to analyze the results that are obtained in 'bdb_analysis_V10'.

```{r}
load("H:/ravi_dsi_summer_project/bdb_analysis_V10/all_results_100_1-25.RData")
```
...
```{r}
write.csv(results_df, "H:/ravi_dsi_summer_project/bdb_analysis_V11/results_df_100_1-25.csv")
```
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = looic, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = TESS, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = log.MSE, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
  facet_grid(Variable_Name ~ Prior_Setting_Class) +
  labs(title = "",
       x = "Heterogeneity Level",
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = per.bias, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
  facet_grid(Variable_Name ~ Prior_Setting_Class) +
  labs(title = "",
       x = "Heterogeneity Level",
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = width_hpd_95, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
  facet_grid(Variable_Name ~ Prior_Setting_Class) +
  labs(title = "",
       x = "Heterogeneity Level",
...
```{r}
ggplot(avg_results_df, aes(x = Heterogeneity_Level_Name, y = coverage_95, group = Prior_Setting, color = Prior_Setting)) +
  geom_line() +
  facet_grid(Variable_Name ~ Prior_Setting_Class) +
  labs(title = "",
       x = "Heterogeneity Level",
...
# Collapsing the results across 7 covariates (including intercept).
